	...
	function chk_CheckNews(){
    	...
    	makeRequest('index.php?option=com_lightchecklist&task=latestNews&tmpl=component');
    	return false;
	}

    function chk_CheckVersion() {
    	document.getElementById('chk_LatestVersion').innerHTML = 'Checking latest version now...';
    	makeRequest('index.php?option=com_lightchecklist&task=latestVersion&tmpl=component');
    	return false;
    }
    ...
    function chk_dateAjaxRef()
    {
        jQuery.ajax({
            type: "POST",
            url: "index.php?option=com_lightchecklist&task=quizcategories.datedb"
        });
    ...
    function chk_dateAjaxIcon()
    {
        jQuery.ajax({
            type: "POST",
            url: "index.php?option=com_lightchecklist&task=checklistcategories.datedb"
        });

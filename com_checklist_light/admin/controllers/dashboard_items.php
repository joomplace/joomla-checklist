...
class LightchecklistControllerDashboard_items extends JControllerAdmin
{
	...
	public function getModel($name = 'Dashboard_items', $prefix = 'LightchecklistModel')
	{
	...
	public function add()
	{
		$this->setRedirect('index.php?option=com_lightchecklist&task=dashboard_item.add');
	}

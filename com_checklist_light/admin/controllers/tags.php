...
class LightchecklistControllerTags extends JControllerAdmin
{
	...
	public function getModel($name = 'Tags', $prefix = 'LightchecklistModel') 
	{
	...
	public function save()
	{
		...
		$app->redirect('index.php?option=com_lightchecklist&view=tags');

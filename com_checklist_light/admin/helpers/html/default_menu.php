            ...
            <div class="nav-collapse-joomlaquiz nav-collapse collapse">
                ...
                <li id="fat-menu" class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="help">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="http://www.joomplace.com/" target="_blank"><?php echo JText::_('COM_LIGHTCHECKLIST_SUBMENU_HELP') ?></a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="http://www.joomplace.com/forum/joomla-components/goals.html" target="_blank"><?php echo JText::_('COM_LIGHTCHECKLIST_ADMINISTRATION_SUPPORT_FORUM') ?></a></li>

...
class LightchecklistModelList extends JModelAdmin
{
	protected $context = 'com_lightchecklist';

	public function getTable($type = 'List', $prefix = 'LightchecklistTable', $config = array()) 
	{
	...
	{
		$form = $this->loadForm('com_lightchecklist.list', 'list', array('control' => 'jform', 'load_data' => false));
		if (empty($form)) {
			return false;
		}
	...
	public function getAuthor()
	{
		...
		$options = array();
		$options[] = JHTML::_('select.option', 0, JText::_('COM_LIGHTCHECKLIST_SELECT_AUTHOR'));

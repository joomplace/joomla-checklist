...
class LightchecklistModelSampledata extends JModelAdmin
{
	//----------------------------------------------------------------------------------------------------
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_lightchecklist.sampledata', 'sampledata', array('control' => 'jform', 'load_data' => $loadData));
	...
	{
		$data = JFactory::getApplication()->getUserState('com_lightchecklist.edit.sampledata.data', array());

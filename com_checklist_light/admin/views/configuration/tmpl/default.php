...
if(!defined('COMPONENT_IMAGES_URL')) define('COMPONENT_IMAGES_URL', JURI::root().'administrator/components/com_lightchecklist/assets/images/');
...
<script type="text/javascript">
	...
	function updateTwitterPreview()
	{
		...
		{
			noticeDiv.innerHTML = '<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_PREVIEW_NOTICE'); ?>';
		}
		else
		{
			noticeDiv.innerHTML = '';
	...
	{
		if (confirm('<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONFIG_RESET_ALL_PERMISSIONS_CONFIRM'); ?>'))
		{
			var link = "<?php echo JURI::root().'administrator/index.php?option=com_lightchecklist&task=configuration.reset_permissions&tmpl=component'; ?>";
			var width = 350;
			var height = 120;
...
<form name="adminForm" id="adminForm" action="index.php" method="post" autocomplete="off" class="form-validate" onsubmit="return false;">
	<input type="hidden" name="option" value="<?php echo 'com_lightchecklist'; ?>" />
	...
	<div id="j-main-container" class="span12 form-horizontal">
		...
		<ul class="nav nav-tabs" id="viewTabs">
			<li><a href="#tab_social" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_SOCIAL_TAB");?></a></li>
			<li><a href="#tab_global_permissions" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_PERMISSIONS_TAB");?></a></li>
			<li><a href="#tab_global_config" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_GLOBAL_CONFIG_TAB");?></a></li>
		</ul>
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab_social">
				...
				<ul class="nav nav-tabs" id="socialTabs">
					<li><a href="#tab_social_google" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_GOOGLEPLUS_SUBPANEL");?></a></li>
					<li><a href="#tab_social_twitter" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_SUBPANEL");?></a></li>
					<li><a href="#tab_social_linkedin" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_LINKEDIN_SUBPANEL");?></a></li>
					<li><a href="#tab_social_facebook" data-toggle="tab"><?php echo  JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_FACEBOOK_SUBPANEL");?></a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="tab_social_google">
						...
						<div class="control-group">
							<div class="control-label">
								<?php
								echo JHTML::_("tooltip", JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_GOOGLEPLUS_PREVIEW_DESC") . '<br/><br/>' .
									'<span>' . "* " . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_GOOGLEPLUS_PREVIEW_NOLANG") . '</span>',
									JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_GOOGLEPLUS_PREVIEW"), null,
									'<label>' . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_GOOGLEPLUS_PREVIEW") . '</label>', null);
								?>
							</div>
							<div class="controls">
					...
					<div class="tab-pane" id="tab_social_twitter">
						...
						<div class="control-group">
							<div class="control-label">
								<?php
								echo JHTML::_("tooltip", JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_PREVIEW_DESC") . '<br/><br/>' .
									'<span>' . "* " . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_PREVIEW_NOLANG") . '</span>',
									JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_PREVIEW"), null,
									'<label>' . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_TWITTER_PREVIEW") . '</label>', null);
								?>
							</div>
							<div class="controls">
					...
					<div class="tab-pane" id="tab_social_linkedin">
						...
						<div class="control-group">
							<div class="control-label">
								<?php
								echo JHTML::_("tooltip", JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_LINKEDIN_PREVIEW_DESC"),
									JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_LINKEDIN_PREVIEW"), null,
									'<label>' . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_LINKEDIN_PREVIEW") . '</label>', null);
								?>
							</div>
							<div class="controls">
					...
					<div class="tab-pane" id="tab_social_facebook">
						...
						<div class="control-group">
							<div class="control-label">
								<?php
								echo JHTML::_("tooltip", JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_FACEBOOK_PREVIEW_DESC") . '<br/><br/>' .
									'<span>' . "* " . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_FACEBOOK_PREVIEW_NOFONT") . '</span>',
									JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_FACEBOOK_PREVIEW"), null,
									'<label>' . JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_FACEBOOK_PREVIEW") . '</label>', null);
								?>
							</div>
							<div class="controls">
			...
			<div class="tab-pane" id="tab_global_permissions">
				<div class="controls checklist_global_permissions">
					...
					<button class="btn btn-small" onclick="onResetPermissoionsLinkClick(this, event);">
						<i class="icon-key"></i>
						<?php echo JText::_("COM_LIGHTCHECKLIST_BE_CONFIG_RESET_ALL_PERMISSIONS"); ?>
					</button>
				</div>
			...
			<div class="tab-pane" id="tab_global_config">
				...
				<fieldset class="form-horizontal">
					<legend><?php echo JText::_('COM_LIGHTCHECKLIST_SETTINGS_EMAILS');?></legend>
					<div class="control-group">

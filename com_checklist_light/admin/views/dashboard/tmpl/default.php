...
<script type="text/javascript">
    ...
    function onBtnCheckLatestVersionClick(sender, event)
    {
        ...
        resultDiv.innerHTML = '<img src="<?php echo JURI::base().'components/com_lightchecklist/assets/images/ajax_loader_16x11.gif'; ?>" />';
        
        var url = '<?php echo JURI::root().'administrator/index.php?option=com_lightchecklist&task=general.get_latest_component_version'; ?>';
        var xmlData = "";
        var syncObject = {};
        var timeout = 5000;
        ...
        if (error == "" && status == 200)
        {
            ...
            else
            {
                resultDiv.innerHTML = '<font color="red">' + version + '</font>&nbsp;<a href="http://www.joomplace.com/members-area.html" target="_blank">' +
                    '<?php echo '(' . JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_UPGRADE') . ')'; ?>' + '</a>';
            }
        }
        else
        {
            resultDiv.innerHTML = '<font color="red">' + '<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_CONNECTION_FAILED'); ?>: ' + error + (error == '' ? '' : ', ') +
                (status == -100 ? '<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_TIMEOUT'); ?>' : status) + '</font>';
        }
    }
    ...
    function onGetLatestVersionTimeout(request, syncObject)
    {
        ...
        resultDiv.innerHTML = '<font color="red">' + '<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_CONNECTION_FAILED'); ?>: ' +
            '<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_TIMEOUT'); ?>' + '</font>';
    }
    
    function getLatestNews()
    {
        var url = '<?php echo JURI::root().'administrator/index.php?option=com_lightchecklist&task=general.get_latest_news'; ?>';
        var xmlData = "";
        var syncObject = {};
        var timeout = 5000;
    ...
    {
        var link = '<?php echo 'index.php?option=com_lightchecklist&task=general.show_changelog&tmpl=component'; ?>';
        var width = 620;
        var height = 620;
...
<div id="pgm_dashboard">
   ...
   <?php } ?>
<div id="dashboard_items" ><a href="index.php?option=com_lightchecklist&view=dashboard_items"><?php echo JText::_('COM_LIGHTCHECKLIST_MANAGE_DASHBOARD_ITEMS');?></a></div>
</div>
    ...
    <table class="table">
        <tr>
            <th colspan="100%" class="checklist_control_panel_title">
                <?php echo JText::_('COM_LIGHTCHECKLIST'); ?>&nbsp;<?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_COMPONENT_DESC') .
                    " 3.0+. " . JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_DEVELOPED_BY'); ?> <a href="http://www.joomplace.com/" target="_blank">JoomPlace</a>.
            </th>
        </tr>
        <tr>
            <td width="120"><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_INSTALLED_VERSION') . ':'; ?></td>
            <td class="checklist_control_panel_current_version"><?php echo $this->config->component_version; ?></td>
        </tr>
        <tr>
            <td><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_LATEST_VERSION') . ':'; ?></td>
            <td>
                <div id="checklistLatestVersion">
                    <button class="btn btn-small" onclick="onBtnCheckLatestVersionClick(this, event);">
                        <i class="icon-health"></i>
                        <?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_CHECK_NOW'); ?>
                    </button>
                </div>
            </td>
         </tr>
         <tr>
            <td><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_ABOUT') . ':'; ?></td>
            <td>
                <?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_ABOUT_DESC'); ?>
            </td>
        </tr>
        <tr>
            <td><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_FORUM') . ':'; ?></td>
            <td>
        ...
        <tr>
            <td><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_CHANGELOG') . ':'; ?></td>
            <td>
                <div class="button2-left"><div class="blank">
                    <button class="btn btn-small" onclick="onBtnShowChangelogClick(this, event);">
                        <i class="icon-file"></i>
                        <?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_CHANGELOG_VIEW'); ?>
                    </button>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <table cellpadding="5" class="checklist_control_panel_news_table">
                    <tr>
                        <td section="">
                            <img src="<?php echo JURI::base().'components/com_lightchecklist/assets/images/tick.png'; ?>"><?php echo JText::_('COM_LIGHTCHECKLIST_BE_CONTROL_PANEL_NEWS_TITLE'); ?>
                        </td>
                    </tr>
                    <tr>
						<td colspan="2">
							<p>Do you know that you can extend your CheckList functionality?<br/>Light Checklist you are currently using is a limited edition of CheckList Component and doesn’t offer the range of features you can find in Standard and Professional versions.<br/>Interested?<br/>Check the options you can get to make your website stand out of the crowd! (<a href="http://www.joomplace.com/joomla-components/checklist-extension.html#features" target="_blank">CheckList Joomla! Component</a>)</p>
						</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="checklist_control_panel_news_cell" style="background-image: linear-gradient(to bottom, #FFFFFF, #EEEEEE);">
                            <div id="checklistLatestNews" class="checklist_control_panel_news">
                                <img src="<?php echo JURI::base().'components/com_lightchecklist/assets/images/ajax_loader_16x11.gif'; ?>" />
                            </div>
                        </td>
                    </tr>
                </table>

...
class LightchecklistViewDashboard_item extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $state;
    public function display($tpl = null)
    {
        ...
        JToolBarHelper::title(JText::_('COM_LIGHTCHECKLIST').': '.JText::_('COM_LIGHTCHECKLIST_DASHBOARD_ITEM_EDITING'));
        $this->addToolBar();

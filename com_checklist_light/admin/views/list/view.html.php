...
/**
 * HTML View class for the Lightchecklist Component
 */
class LightchecklistViewList extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
    ...
    public function display($tpl = null) 
    {
		...
		$submenu = 'user_list';
		LightchecklistHelper::showTitle($submenu, 'pencil-2');	 
		$this->addTemplatePath(JPATH_BASE.'/components/com_lightchecklist/helpers/html');
		
		$this->defaultlist = $session->get('com_lightchecklist.defaultlist');

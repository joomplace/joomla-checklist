        ...
        <table class="table table-striped" id="Checklists">
            <thead>
				<tr>
					...
					<th width="10%">
						<?php echo JText::_('COM_LIGHTCHECKLIST_EDITLIST'); ?> 
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_AUTHOR', 'user_id', $listDirn, $listOrder); ?> 
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_PUBLISH_DATE', 'publish_date', $listDirn, $listOrder); ?>
					</th>
					<th width="40%">
						<?php echo JText::_('COM_LIGHTCHECKLIST_FORM_TAGS'); ?> 
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_DEFAULT_CHECKLIST', 'default', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
                        <div class="pull-left">
                            ...
                            if ($canEdit) : ?>
								<a title="<?php echo $this->escape(strip_tags($item->title)); ?>" href="<?php echo JRoute::_('index.php?option=com_lightchecklist&task=list.edit&id='.$item->id);?>">
							...
							<a href="index.php?option=com_lightchecklist&view=requests&checklist_id=<?php echo $item->id;?>">
								<span class="label label-info" style="margin-left:10px;"><?php echo JText::_('COM_LIGHTCHECKLIST_REQUEST')?></span>
							</a>
                            <?php endif;?>
                        </div>
					</td>
					<td>
                        <div>
                            <a href="index.php?option=com_lightchecklist&view=checklist&id=<?php echo $item->id;?>"><img src="<?php echo JURI::base()?>components/com_lightchecklist/assets/images/list_bullets.png" title="<?php echo JText::_('COM_LIGHTCHECKLIST_EDITLIST'); ?>"/></a>
                        </div>
					</td>
					<td>
                        <div>
					...
					<td>
                        <div class="pull-center">
							...
							<img src="<?php echo JURI::base()?>components/com_lightchecklist/assets/images/tick2.png" />
							<?php } else {?>
							<img src="<?php echo JURI::base()?>components/com_lightchecklist/assets/images/publish_x.png" />
							<?php }?>
                        </div>
                    </td>
				</tr>
                ...
                <?php } else { ?>
                        <tr>
                            <td colspan="8" align="center" >
                                ...
                                <a href="<?php echo JRoute::_('index.php?option=com_lightchecklist&task=list.add'); ?>" >
                                    <?php echo JText::_('COM_LIGHTCHECKLIST_CREATEANEWONE'); ?>
                                </a>
                            </td>
                        </tr>
                <?php }?>

...
<form action="<?php echo JRoute::_('index.php?option=com_lightchecklist&layout=edit&user_id='.(int) $this->item->id); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="user-form" class="form-validate">

	<div id="j-main-container" class="span10 form-horizontal">
	<ul class="nav nav-tabs" id="userTabs">
	    <li class="active"><a href="#user-details" data-toggle="tab"><?php echo  JText::_('COM_LIGHTCHECKLIST_USER_DETAILS');?></a></li>
	    <li><a href="#user-info" data-toggle="tab"><?php echo  JText::_('COM_LIGHTCHECKLIST_USER_INFO');?></a></li>
	</ul>
			...
			<fieldset class="adminform">
				<div class="control-group">
	                <div class="control-label">
					    <label class=" required control-label" for="jform_avatar" id="jform_name-lbl"><?php echo JText::_('COM_LIGHTCHECKLIST_USER_AVATAR')?></label>
	                </div>
					<div class="controls">
						<input type="file" name="avatar_file" class="btn" id="avatar">
						<button onclick="Checklist.uploadFile();" type="button" class="btn btn-primary btn-lg"><?php echo JText::_('COM_LIGHTCHECKLIST_UPLOAD_PROFILE');?></button>
						<img src="<?php echo JURI::root();?>components/com_lightchecklist/assets/images/ajax-loader.gif" style="display: none;" id="ajax_loader_profile">
					</div>
				</div>
				<div class="control-group">
	                <div class="control-label">
				...
				<div class="control-group">
	                <div class="control-label">
					    <label class=" required control-label" for="jform_name" id="jform_name-lbl"><?php echo JText::_('COM_LIGHTCHECKLIST_UNAME')?><span class="star">&nbsp;*</span></label>
	                </div>
					<div class="controls">
				...
				<div class="control-group">
	                <div class="control-label">
					    <label class=" required control-label" for="jform_username" id="jform_username-lbl"><?php echo JText::_('COM_LIGHTCHECKLIST_USERNAME')?><span class="star">&nbsp;*</span></label>
	                </div>
					<div class="controls">
				...
				<div class="control-group">
	                <div class="control-label">
					    <label class=" required control-label" for="jform_email" id="jform_email-lbl"><?php echo JText::_('COM_LIGHTCHECKLIST_USER_EMAIL')?><span class="star">&nbsp;*</span></label>
	                </div>
					<div class="controls">
...
Checklist.uploadFile = function(){
	...
	if(filename != ''){
		...
		alert('<?php echo JText::_('COM_LIGHTCHECKLIST_PLEASE_SELECT_AN_IMAGE');?>');
		return false;
	}
}
</script>

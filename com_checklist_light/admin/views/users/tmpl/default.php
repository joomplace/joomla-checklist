...
<form action="<?php echo JRoute::_('index.php?option=com_lightchecklist&view=users'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="table table-striped" id="Checklists">
            <thead>
				<tr>
					...
					<th width="30%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_UNAME', 'name', $listDirn, $listOrder); ?> 
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_USERNAME', 'username', $listDirn, $listOrder); ?>
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_USER_EMAIL', 'email', $listDirn, $listOrder); ?>
					</th>
					<th width="40%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_USER_LASTVISIT_DATE', 'lastvisitDate', $listDirn, $listOrder); ?>
					</th>
					<th width="10%">
						<?php echo JHtml::_('grid.sort', 'COM_LIGHTCHECKLIST_USER_REGISTER_DATE', 'registerDate', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
                        <div class="pull-left">
                            ...
                            if ($canEdit) : ?>
								<a title="<?php echo $this->escape(strip_tags($item->name)); ?>" href="<?php echo JRoute::_('index.php?option=com_lightchecklist&view=user&layout=edit&user_id='.$item->id);?>">

...
class com_lightchecklistInstallerScript
{
	...
	function postflight($type, $parent)
    {
		...
		if(!$db->loadResult()){
			$db->setQuery("INSERT INTO `#__checklist_dashboard_items` (`id`, `title`, `url`, `icon`, `published`) VALUES (1, 'User checklists', 'index.php?option=com_lightchecklist&view=lists', '".JURI::root()."media/com_lightchecklist/preferences_contact_list.png', 1), (2, 'Available checklists', 'index.php?option=com_lightchecklist&view=lists&defaultlist=1', '".JURI::root()."media/com_lightchecklist/to_do_list_checked3.png', 1), (3, 'User list', 'index.php?option=com_lightchecklist&view=users', '".JURI::root()."media/com_lightchecklist/users_2.png', 1), (4, 'Configuration', 'index.php?option=com_lightchecklist&view=configuration', '".JURI::root()."media/com_lightchecklist/settings.png', 1), (5, 'Tags', 'index.php?option=com_lightchecklist&view=tags', '".JURI::root()."media/com_lightchecklist/rss_tag.png', 1);");
			$db->execute();
		}

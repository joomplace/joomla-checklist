...
var Checklist = {
	...
	doAjax: function(task, params, feedback, object){
		...
		jQuery.ajax({
			url: "index.php?option=com_lightchecklist&task=" + task,
			type: "POST",
			data: params,
			dataType: "html",
	...
	editChecklist: function(img){
		...
		var content_iframe = jQuery("#content_iframe").attr('src','index.php?option=com_lightchecklist&view=edit_checklist&checklist_id=' + checklistid + '&tmpl=component');

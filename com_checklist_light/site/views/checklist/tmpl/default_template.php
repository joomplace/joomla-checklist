...
$document->addStyleSheet(JURI::root()."components/com_lightchecklist/assets/css/default_template/checklist.css");
$document->addScript(JURI::root()."components/com_lightchecklist/assets/js/modernizr-2.6.2.js");
$document->addScript(JURI::root()."components/com_lightchecklist/assets/js/default_template/script.js");
$document->addScript(JURI::root()."components/com_lightchecklist/assets/js/jquery-scrolltofixed-min.js");
...
<style>
	...
	@font-face {
		...
		src:url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/default_template/fonts/glyphicons-halflings-regular.eot');
		src:url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/default_template/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/default_template/fonts/glyphicons-halflings-regular.woff') format('woff'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/default_template/fonts/glyphicons-halflings-regular.ttf') format('truetype'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/default_template/fonts/glyphicons-halflings-regular.svg#halflings') format('svg');
		font-weight: normal;
		font-style: normal;
	}
...
<div id="checklist">
    ...
    <div class="progress progress-striped">
		  ...
		  <span id="well-done" class="label label-success"><?php echo JText::_('COM_LIGHTCHECKLIST_WELL_DONE');?></span>
	      <a href="javascript:void(0);" id="reset"><span class="label label-default"><?php echo JText::_('COM_LIGHTCHECKLIST_RESET')?></span></a>
    </div>
...
<?php
	...
	$pageLink = JRoute::_('index.php?option=com_lightchecklist&view=checklist&id='.$this->checklist->id.'&userid='.$userid.'&Itemid='.$itemid, false, -1);

...
<style>
	...
	@font-face {
		font-family: 'icomoon';
		src:url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/joomplace_style/fonts/icomoon.eot');
		src:url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/joomplace_style/fonts/icomoon.eot?#iefix') format('embedded-opentype'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/joomplace_style/fonts/icomoon.woff') format('woff'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/joomplace_style/fonts/icomoon.ttf') format('truetype'),
			url('<?php echo JURI::root();?>components/com_lightchecklist/assets/css/joomplace_style/fonts/icomoon.svg#icomoon') format('svg');
		font-weight: normal;
		font-style: normal;
	}

...
class ChecklistControllerGeneral extends JControllerLegacy
{
	//----------------------------------------------------------------------------------------------------
	public function get_latest_component_version()
	{
		require_once(JPATH_SITE."/administrator/components/com_checklist/libs/Snoopy.php");
		require_once(JPATH_SITE."/administrator/components/com_checklist/libs/MethodsForXml.php");

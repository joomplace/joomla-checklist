...
$document->addStyleSheet(JURI::base()."components/com_checklist/assets/css/style.css");
		...
		<div class="chk-add-group">
			<form class="form-horizontal" role="form" style="margin-top:15px;">
				<div class="form-group-checklist">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputGroup" placeholder="<?php echo JText::_('COM_CHECKLIST_GROUP_NAME_PLACEHOLDER')?>" style="margin-right:10px;">

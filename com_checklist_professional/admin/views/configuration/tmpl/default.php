...
<form name="adminForm" id="adminForm" action="index.php" method="post" autocomplete="off" class="form-validate" >
	...
	<div id="j-main-container" class="span12 form-horizontal">
		...
		<ul class="nav nav-tabs" id="viewTabs">
			...
			<li><a href="#tab_disqus" data-toggle="tab"><?php echo  JText::_("COM_CHECKLIST_BE_CONFIG_DISQUS_TAB");?></a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab_disqus">
				<fieldset class="form-horizontal">
					<legend><?php echo JText::_('COM_CHECKLIST_SETTINGS_INTEGRATIONS_PAGE_COMMENTS');?></legend>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('useDisqus'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('useDisqus'); ?></div>
					</div>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('disqusSubDomain'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('disqusSubDomain'); ?></div>
					</div>
				</fieldset>
			</div>
			...
			<div class="tab-pane" id="tab_global_config">
				...
				<fieldset class="form-horizontal">
					<legend><?php echo JText::_('COM_CHECKLIST_SETTINGS_EXPORT_PRINT_OPTIONS');?></legend>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('print_option'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('print_option'); ?></div>
					</div>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('pdf_option'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('pdf_option'); ?></div>
					</div>
				</fieldset>
				<fieldset class="form-horizontal">
					<legend><?php echo JText::_('COM_CHECKLIST_SETTINGS_RATING_OPTIONS');?></legend>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('rating_option'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('rating_option'); ?></div>
					</div>
				</fieldset>
			</div>

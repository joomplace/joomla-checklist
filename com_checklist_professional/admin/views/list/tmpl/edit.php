...
<form action="<?php echo JRoute::_('index.php?option=com_checklist&layout=edit&id='.(int) $this->item->id); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="list-form" class="form-validate">
	<div id="j-main-container" class="span10 form-horizontal">
	<ul class="nav nav-tabs" id="listTabs">
	    <li class="active"><a href="#list-details" data-toggle="tab"><?php echo  JText::_('COM_CHECKLIST_LIST_DETAILS');?></a></li>
	    <li><a href="#list-publication" data-toggle="tab"><?php echo  JText::_('COM_CHECKLIST_LIST_PUBLICATION');?></a></li>
	    <li><a href="#list-permissions" data-toggle="tab"><?php echo  JText::_('COM_CHECKLIST_LIST_PERMISSIONS');?></a></li>
		<li><a href="#list-metadata" data-toggle="tab"><?php echo  JText::_('COM_CHECKLIST_LIST_METADATA');?></a></li>
		<li><a href="#global-permissions" data-toggle="tab"><?php echo  JText::_('COM_CHECKLIST_GLOBAL_PERMISSIONS');?></a></li>
	</ul>

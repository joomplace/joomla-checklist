...
<style type="text/css">
	...
	.progress-container, .checklist-edit-mode, .chk-toolbar
	{
		display: none;
	}
	...
	@media print {
		...
		.caret, em, .checklist-rating > strong, .rating
		{
			visibility: hidden;
		}
...
<div class="btn hidden-print" id="pop-print">
	<a onclick="printBlank();" href="javascript:void(0);">
		&nbsp;<?php echo JText::_('COM_CHECKLIST_PRINT_BLANK');?>&nbsp;
	</a>
</div>
<div class="btn hidden-print" id="pop-print">
	<a onclick="printCurrent();" href="javascript:void(0);">
		&nbsp;<?php echo JText::_('COM_CHECKLIST_PRINT_CURRENT_STATE');?>&nbsp;
	</a>
</div>
...
<script type="text/javascript">
	...
	{
		jQuery(".checklist-section-details").css('display', 'block');
		jQuery(".checklist-section-details").css('height', 'auto');
		jQuery(".checklist-section-details").css('maxHeight', '500px');
		return true;
	}

	function collapseAllItems()
	{
		jQuery(".checklist-section-details").css('display', 'none');
		jQuery(".checklist-section-details").css('height', 'auto');
...
<script type="text/javascript">
	...
	var Checklist = {
		...
		showSavedItem: function(json, element){
			...
			changed_li.find("label").html(data['title'] + '<img onclick="Checklist.ajaxRemoveItem(this, event);" class="chk-tools" src="' + chk_base_URL + 'components/com_checklist/assets/images/trash_recyclebin_empty_closed_w.png" style="display: none;"><img onclick="Checklist.editItem(this, event);" class="chk-tools pencil" src="' + chk_base_URL + 'components/com_checklist/assets/images/pencil2.png" style="display: none;">');

...
<form action="<?php echo JRoute::_('index.php?option=com_checklist&view=dashboard_items'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
                                ...
                                <th width="15%">
                                    <?php echo JHtml::_('grid.sort', 'COM_CHECKLIST_DASHBOARD_ITEM_URL', 'url', $listDirn, $listOrder); ?>
                                </th>
                                <th width="5%">
                                    <?php echo JHtml::_('grid.sort', 'COM_CHECKLIST_DASHBOARD_ITEM_ICON', 'icon', $listDirn, $listOrder); ?>
                                </th>
								<th width="5%">
									<?php echo JHtml::_('grid.sort', 'COM_CHECKLIST_PUBLISHED', 'published', $listDirn, $listOrder); ?>
								</th>
						...
						<?php if (sizeof($this->items)) {foreach($this->items as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td>
									<a href="<?php echo JRoute::_('index.php?option=com_checklist&task=dashboard_item.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_CHECKLIST_DASHBOARD_ITEMS_NONE', 'dashboard items'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_checklist&task=dashboard_item.add'); ?>" >
										<?php echo JText::_('COM_CHECKLIST_DASHBOARD_ITEMS_NONE_A'); ?>
									</a>
								</td>
							</tr>
						<?php } ?>

...
<form action="<?php echo JRoute::_('index.php?option=com_checklist&view=tags'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="table table-striped" id="Tags">
			...
			<?php if(sizeof($this->items)){foreach ($this->items as $i => $item) :?>
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
                        <div class="pull-left">
							<a title="<?php echo $this->escape(strip_tags($item->name)); ?>" href="<?php echo JRoute::_('index.php?option=com_checklist&view=tags&layout=tag&id='.$item->id.'&tmpl=component');?>" class="modal" rel="{handler: 'iframe', size: {x: 460, y: 100}}">
					...
					<td>
                        <div class="pull-left">
                        	<a style="text-decoration:none;" title="" href="<?php echo JRoute::_('index.php?option=com_checklist&view=tags&layout=lists&id='.$item->id.'&tmpl=component');?>" class="modal" rel="{handler: 'iframe', size: {x: 560, y: 450}}">
								<span class="tm-tag"><?php echo JText::_('COM_CHECKLIST_SHOW_LISTS') ?></span>
							</a>
                        </div>
					</td>
					<td>
...
<script type="text/javascript">
	...
	function openModalWindow(isNew)
	{
		...
		SqueezeBox.fromElement('index.php?option=com_checklist&view=tags&layout=tag&tmpl=component&id=' + cid, options);
	}

...
<fieldset class="adminform">
	<div class="control-group">
		<?php echo JText::_('COM_CHECKLIST_TAG_NAME'); ?>
...
<script type="text/javascript">
	function redirectToTags(tag_id)
	{
		...
		if(name == ''){
			alert('<?php echo JText::_('COM_CHECKLIST_NAME_IS_EMPTY');?>');
			return false;
		}
		name = encodeURIComponent(name);

		parent.location.href = 'index.php?option=com_checklist&task=tags.save&id=' + tag_id + '&name=' + name;
		return false;
	}

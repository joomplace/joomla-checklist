...
<?php if(count($this->checklists)):?>
  <form name="adminForm" id="adminForm"
        action="<?php echo /*JRoute::_('index.php?option=com_checklist&view=tag'.$itemid);*/ htmlspecialchars(JUri::getInstance()->toString());?>"
        method="post">
	<ul class="media-list">
	<li class="media">
	...
	<?php foreach ($this->checklists as $checklist) {?>
	  <li class="media">
		  <div class="media-body">
		    <h4 class="media-heading"><a href="<?php echo JRoute::_('index.php?option=com_checklist&view=checklist&id='.$checklist->id.'&user_id='.$checklist->user_id); ?>"><?php echo $checklist->title;?></a></h4>
		  ...
		  <div>
			  ...
			  <div style="float:right;">
				  ...
				  <ul class="dropdown-menu" role="menu" >
				    <li><a href="<?php echo JRoute::_('index.php?option=com_checklist&view=checklist&id='.$checklist->id.'&user_id='.$checklist->user_id); ?>"><?php echo JText::_('COM_CHECKLIST_SHOW_CHECKLIST')?></a></li>
				  </ul>
				</div>
